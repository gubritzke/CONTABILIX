        ...
        <div class="">
            <div class="row">
                <div class="col-lg-7 col-md-12 text-banner">
                    ...
                    <div class="buttons">
                        <a href="javascript:;" class="bt bg-green-200 cl-white font-s bt-1">ABRIR MINHA EMPRESA <span class="bg-yellow-300 cl-blue-800 font-pp">grátis</span></a>
                        <a href="javascript:;" class="bt bg-green-200 cl-white font-s bt-2">TROCAR DE CONTADOR <span class="bg-yellow-300 cl-blue-800 font-pp">1º mês grátis</span></a>
                    </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12">
                ...
                <div class="col-12">
                    <p class="font-s">
                        Nosso time de atendimento ao cliente está disponível de segunda a sexta-feira para auxiliar nas sua dúvidas, independente do seu plano de serviços.
                    </p>
                </div>
